...
class ValiderFicheType extends AbstractType
{
    ...
    {        
        $builder
            ...
            ->add('idVisiteur', EntityType::class, array('class' => Visiteur::class, 'choice_label' => function($fiche) {return $fiche->getNom() . " " . $fiche->getPrenom();}, 'label' => 'Visiteur : ', 'attr' => array('class' => 'form-control')))
        ;
    }
